...
export type TodoItem = {
    ...
    size: Size;
    reminderDate?: string; // Дата напоминания, при создании новой задачи - пустая строка // 2026-07-03 09:30
    notificationId?: string; // ID уведомления, при создании новой задачи - пустая строка
