...
<reference>
@D:/myProjects/Android/wellWell/.kilo/gsd-core/references/user-profiling.md
...
Read the user-profiling reference document at `D:/myProjects/Android/wellWell/.kilo/gsd-core/references/user-profiling.md` to load:
