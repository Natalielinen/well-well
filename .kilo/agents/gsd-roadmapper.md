...
Reference full template: `D:/myProjects/Android/wellWell/.kilo/gsd-core/templates/roadmap.md`

## STATE.md Structure

Use template from `D:/myProjects/Android/wellWell/.kilo/gsd-core/templates/state.md`.
