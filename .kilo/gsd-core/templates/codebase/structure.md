...
- Usage: Reference from command with `@D:/myProjects/Android/wellWell/.kilo/gsd-core/workflows/{name}.md`
...
**gsd-core/**
- Purpose: Resources installed to D:/myProjects/Android/wellWell/.kilo/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to D:/myProjects/Android/wellWell/.kilo/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
