...
<!-- For checkpoint task examples and patterns, see @D:/myProjects/Android/wellWell/.kilo/gsd-core/references/checkpoints.md -->
...
See `D:/myProjects/Android/wellWell/.kilo/gsd-core/references/tdd.md` for TDD plan structure.
...
See `D:/myProjects/Android/wellWell/.kilo/gsd-core/templates/user-setup.md` for full schema and examples
...
See `D:/myProjects/Android/wellWell/.kilo/gsd-core/workflows/verify-phase.md` for verification logic.
