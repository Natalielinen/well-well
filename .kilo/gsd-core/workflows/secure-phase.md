...
```
Agent(
  prompt="Read D:/myProjects/Android/wellWell/.kilo/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `D:/myProjects/Android/wellWell/.kilo/gsd-core/templates/SECURITY.md`
