...
<template>
@D:/myProjects/Android/wellWell/.kilo/gsd-core/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@D:/myProjects/Android/wellWell/.kilo/gsd-core/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `D:/myProjects/Android/wellWell/.kilo/gsd-core/workflows/transition.md`.
...
- Follow @D:/myProjects/Android/wellWell/.kilo/gsd-core/workflows/diagnose-issues.md
