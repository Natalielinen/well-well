...
<required_reading>
@D:/myProjects/Android/wellWell/.kilo/gsd-core/references/user-story-template.md
@D:/myProjects/Android/wellWell/.kilo/gsd-core/references/spidr-splitting.md
@D:/myProjects/Android/wellWell/.kilo/gsd-core/references/planner-mvp-mode.md
</required_reading>
...
Normalize per `@D:/myProjects/Android/wellWell/.kilo/gsd-core/references/phase-argument-parsing.md` (zero-pad integer phases to two digits).
...
Run three sequential `question` calls. Each is free-text. After all three, assemble into the canonical sentence per `@D:/myProjects/Android/wellWell/.kilo/gsd-core/references/user-story-template.md`:
...
Run the SPIDR rules from `@D:/myProjects/Android/wellWell/.kilo/gsd-core/references/spidr-splitting.md`. Briefly:
