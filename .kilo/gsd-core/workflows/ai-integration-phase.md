...
<required_reading>
@D:/myProjects/Android/wellWell/.kilo/gsd-core/references/ai-frameworks.md
@D:/myProjects/Android/wellWell/.kilo/gsd-core/references/ai-evals.md
</required_reading>
...
```markdown
Read D:/myProjects/Android/wellWell/.kilo/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "D:/myProjects/Android/wellWell/.kilo/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read D:/myProjects/Android/wellWell/.kilo/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read D:/myProjects/Android/wellWell/.kilo/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read D:/myProjects/Android/wellWell/.kilo/agents/gsd-eval-planner.md for instructions.
