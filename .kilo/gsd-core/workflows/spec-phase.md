...
ones). Reference: @D:/myProjects/Android/wellWell/.kilo/gsd-core/references/edge-probe.md.
...
# — NOT the consuming project's git root — falling back to git toplevel / D:/myProjects/Android/wellWell/.kilo.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  "D:/myProjects/Android/wellWell/.kilo/gsd-core/bin/lib/edge-probe.cjs" \
  "D:/myProjects/Android/wellWell/.kilo/bin/lib/edge-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
requirement list). Reference: @D:/myProjects/Android/wellWell/.kilo/gsd-core/references/prohibition-probe.md — the
...
Use the SPEC.md template from @D:/myProjects/Android/wellWell/.kilo/gsd-core/templates/spec.md.
