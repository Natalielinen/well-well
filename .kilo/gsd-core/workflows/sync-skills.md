...
INSTALL_JS_GLOBAL="D:/myProjects/Android/wellWell/.kilo/gsd-core/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node D:/myProjects/Android/wellWell/.kilo/gsd-core/bin/install.js --global --<runtime>
```
Then exit.
