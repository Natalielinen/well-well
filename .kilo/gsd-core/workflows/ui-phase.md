...
```markdown
Read D:/myProjects/Android/wellWell/.kilo/agents/gsd-ui-researcher.md for instructions.
...
Template: D:/myProjects/Android/wellWell/.kilo/gsd-core/templates/UI-SPEC.md
</output>
...
```markdown
Read D:/myProjects/Android/wellWell/.kilo/agents/gsd-ui-checker.md for instructions.
...
@D:/myProjects/Android/wellWell/.kilo/gsd-core/references/ui-consideration-probe.md.
...
# (#448) — NOT the consuming project's git root — falling back to git toplevel / D:/myProjects/Android/wellWell/.kilo.
...
UI_PROBE_JS=$(for _c in \
  ...
  "D:/myProjects/Android/wellWell/.kilo/gsd-core/bin/lib/ui-consideration-probe.cjs" \
  "D:/myProjects/Android/wellWell/.kilo/bin/lib/ui-consideration-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
