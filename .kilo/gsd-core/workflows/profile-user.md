...
Key references:
- @D:/myProjects/Android/wellWell/.kilo/gsd-core/references/ui-brand.md (display patterns)
- @D:/myProjects/Android/wellWell/.kilo/agents/gsd-user-profiler.md (profiler agent definition)
- @D:/myProjects/Android/wellWell/.kilo/gsd-core/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="D:/myProjects/Android/wellWell/.kilo/gsd-core/USER-PROFILE.md"
...
```bash
cp "D:/myProjects/Android/wellWell/.kilo/gsd-core/USER-PROFILE.md" "D:/myProjects/Android/wellWell/.kilo/USER-PROFILE.backup.md"
```
...
✓ Stores profile at D:/myProjects/Android/wellWell/.kilo/gsd-core/USER-PROFILE.md
...
- The user-profiling reference doc at `D:/myProjects/Android/wellWell/.kilo/gsd-core/references/user-profiling.md`
...
Reference: @D:/myProjects/Android/wellWell/.kilo/gsd-core/references/user-profiling.md
...
Display: "✓ Profile written to D:/myProjects/Android/wellWell/.kilo/gsd-core/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global AGENTS.md" -- "Add profile to D:/myProjects/Android/wellWell/.kilo/AGENTS.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at D:/myProjects/Android/wellWell/.kilo/gsd-core/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at D:/myProjects/Android/wellWell/.kilo/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to D:/myProjects/Android/wellWell/.kilo/AGENTS.md"
...
```bash
BACKUP_PATH="D:/myProjects/Android/wellWell/.kilo/USER-PROFILE.backup.md"
```
...
Your profile:    D:/myProjects/Android/wellWell/.kilo/gsd-core/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   D:/myProjects/Android/wellWell/.kilo/skills/gsd-dev-preferences/SKILL.md
  ✓ AGENTS.md section       <resolved claude_md_path, default ./.kilo/AGENTS.md>
  ✓ Global AGENTS.md        D:/myProjects/Android/wellWell/.kilo/AGENTS.md
```
