...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `D:/myProjects/Android/wellWell/.kilo/.gsd-surface.json`
(sibling to `D:/myProjects/Android/wellWell/.kilo/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `D:/myProjects/Android/wellWell/.kilo/skills/gsd-*/`.
...
(`~/.config/kilo`), NOT the skills sub-directory (`D:/myProjects/Android/wellWell/.kilo/skills`).
...
`D:/myProjects/Android/wellWell/.kilo/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `D:/myProjects/Android/wellWell/.kilo/.gsd-surface.json`).
...
<execution_context>
Surface state file: `D:/myProjects/Android/wellWell/.kilo/.gsd-surface.json`
Install profile marker: `D:/myProjects/Android/wellWell/.kilo/.gsd-profile`
Skill dirs: `D:/myProjects/Android/wellWell/.kilo/skills/gsd-*/`
Engine module: `D:/myProjects/Android/wellWell/.kilo/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `D:/myProjects/Android/wellWell/.kilo/gsd-core/bin/lib/clusters.cjs`
</execution_context>
